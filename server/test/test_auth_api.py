...
class TestAuthAPI(DigiScriptTestCase):
    ...
    def test_invalid_admin(self):
        ...
        self.assertEqual(400, response.code)
        self.assertTrue('message' in response_body)
        self.assertEqual('Admin user cannot have a show allocation', response_body['message'])
    ...
    def test_invalid_user(self):
        ...
        self.assertEqual(400, response.code)
        self.assertTrue('message' in response_body)
        self.assertEqual('Non admin user requires a show allocation', response_body['message'])
