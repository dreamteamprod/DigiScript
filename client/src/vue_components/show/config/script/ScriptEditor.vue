...
export default {
  ...
  computed: {
    ...
    scriptChanges() {
      ...
      Object.keys(this.TMP_SCRIPT).forEach(function checkPageChanges(pageNo) {
  ...
  methods: {
    ...
    deleteLine(pageIndex, lineIndex) {
      ...
      this.editPages.forEach(function updateEditPageIndices(editPage, index) {
    ...
    async insertLineAt(pageIndex, lineIndex) {
      ...
      this.editPages.forEach(function updateEditPageIndicesAfterInsert(editPage, index) {
        const editParts = editPage.split('_');
        const editPageIndex = parseInt(editParts[1], 10);
        const editIndex = parseInt(editParts[3], 10);
